...
\begin{itemize}
	...
	\item \textbf{Diagnóstico Local:} Implementa un sistema de \textit{logging} persistente en la memoria flash (\textit{LittleFS}), accesible a través de una interfaz web interna para tareas de mantenimiento y depuración.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Panel de Monitoreo y Herramientas:} Una vez establecida la conexión, el gateway sirve una interfaz web que permite visualizar el estado de la conexión MQTT, las versiones de firmware de ambos microcontroladores y realizar acciones de mantenimiento como el reinicio remoto del dispositivo.
...
\begin{itemize}
	\item \textbf{Instrumental de Laboratorio (Proporcionado por la Universidad):}
	      \begin{itemize}
