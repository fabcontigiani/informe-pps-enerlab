...
\begin{itemize}
  ...
  \item \textbf{ZMPT101B (Sensor de Tensión):} Transformador de tensión diseñado para la medición de tensiones alternas de hasta \qty{1}{\kilo\volt} \cite{zmpt101b_ds}. Su rango de operación resulta adecuado para las tensiones nominales de la red de distribución eléctrica comercial y residencial.
