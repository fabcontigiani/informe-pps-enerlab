...
Para la integración física de los componentes y la validación del prototipo, se diseñó un circuito impreso (PCB) utilizando la herramienta de diseño electrónico automatizado (EDA) \textbf{KiCad}, cuyo diagrama esquemático se presenta en la figura~\ref{fig:pcb_schematic}.
...
\begin{figure}[H]
  ...
  \caption{Curvas de error y linealidad obtenidas en la primera etapa de ensayos con alimentación trifásica (\qty{0.6}{\ampere} a \qty{15}{\ampere}).}
...
\begin{figure}[H]
  ...
  \caption{Curvas de error y linealidad obtenidas en la segunda etapa de ensayos con alimentación monofásica en paralelo (\qty{5}{\ampere} a \qty{50}{\ampere}).}
...
La implementación del sistema de ajuste automático de rango (\textit{auto-ranging}) representó uno de los mayores desafíos y logros técnicos del proyecto. Este mecanismo permitió extender significativamente el rango dinámico del medidor, garantizando la exactitud en mediciones de hasta \qty{70}{\ampere} RMS. Esto lo posiciona como una solución sumamente versátil para el monitoreo de instalaciones residenciales y comerciales donde las variaciones de carga y generación pueden ser muy amplias a lo largo del día.
